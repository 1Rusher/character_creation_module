...
def attack(char_name: str, char_class: str) -> str:
    if char_class == 'warrior':
        return (f'{char_name} нанёс противнику {5 + randint(3, 5)} урона')
    if char_class == 'mage':
        return (f'{char_name} нанёс противнику {5 + randint(5, 10)} урона')
    if char_class == 'healer':
        return (f'{char_name} нанёс противнику {5 + randint(-3, -1)} урона')
    return None
